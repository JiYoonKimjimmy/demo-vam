...
data class WooriBankManagementRequest(
    ...
    @field:Length(min = 0, max = 4, message = "responseCode length are allowed from 4 to 4 characters.")
    val responseCode: String?,
    @field:Length(min = 0, max = 6, message = "orgMessageNo length are allowed from 6 to 6 characters.")
    ...
    @field:Length(min = 1, max = 6, message = "trBranch length are allowed from 1 to 6 characters.")
    val trBranch: String,
    @field:Length(min = 0, max = 20, message = "depositorName length are allowed from 1 to 20 characters.")
    ...
    // request layer
    @field:Length(min = 0, max = 1, message = "cashDepositYn length are allowed from 1 to 1 characters.")
    val cashDepositYn: String?,
    @field:Min(0) @field:Max(9_999_999_999_999)
    val cashierCheckAmount: Int,
    @field:Length(min = 0, max = 7, message = "branchCode length are allowed from 7 to 7 characters.")
