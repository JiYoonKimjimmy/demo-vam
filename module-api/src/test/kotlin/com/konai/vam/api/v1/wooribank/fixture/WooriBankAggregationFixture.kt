...
import com.konai.vam.api.v1.wooribank.service.domain.WooriBankAggregation
import com.konai.vam.core.enumerate.WooriBankAggregateResult
import java.time.LocalDate

class WooriBankAggregationFixture {

    fun getDomain(aggregateDate: String = LocalDate.now().toString()): WooriBankAggregation {
