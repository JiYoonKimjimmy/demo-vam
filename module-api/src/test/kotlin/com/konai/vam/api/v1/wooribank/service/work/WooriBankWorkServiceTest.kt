...
class WooriBankWorkServiceTest : CustomBehaviorSpec({
    ...
    given("우리은행 '업무 개시' 전문 연동 요청하여") {
        ...
        val postWooriBankWorkResponse = PostWooriWorkResponse(wooriBankCommonMessageFixture.make(message.requestCode, "000001"))
        every { mockWooriBankRestClient.postWooriBankWork(any()) } returns postWooriBankWorkResponse
